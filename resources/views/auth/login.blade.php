        ...
        <div class="row no-gutters">
          ...
          <div class="col-md-7">
            <div class="card-body">
              ...
              <p class="login-card-description">Profilga kirish</p>
              <form action="{{ route('login')}}" method="POST" >
                @csrf
                  ...
                  <div class="form-group mb-4">
                    ...
                    <input type="password" name="password" id="password" class="form-control @error('email') is-invalid @enderror" placeholder="***********" value="{{ old('email') }}" required autocomplete="email" autofocus>
                    @error('password')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
            ...
            @endif
                <p class="login-card-footer-text">Ro'yxatdan o'tish super admin tamonidan cheklangan !</p>
